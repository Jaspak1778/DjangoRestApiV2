...
CORS_ALLOWED_ORIGINS = [
    "https://localhost:3000",  # Lisää tämä, jos käytät Blazor Server -sovellusta
]
#Django 4 ---> tarvitaan cross site request forgery määritys
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:3000",  # Muokkaa tämä vastaamaan Blazor-sovelluksesi URL:ia
    "http://127.0.0.1:5000",   # Tarvittaessa lisää tämä myös
]
